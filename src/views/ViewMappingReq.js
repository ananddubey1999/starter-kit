    ...
    function ViewMappingReq() {
     ...
     <Row style={{borderLeft: "1px solid gray", borderRight: "1px solid gray", borderRadius: "0px 0px 0px 0px", height: "auto" }} className="bg-white pt-2">
         <Col md="3" className='justify-content-start align-items-start'>
             ...
             <Form.Control type="Date" placeholder="2024-03-11" style={{ border: "2px solid gray" }}/>
             </Form.Group>
         </Col>
         <Col md="3">
     ...
     <Row style={{borderLeft: "1px solid gray", borderRight: "1px solid gray", borderRadius: "0px 0px 0px 0px", height: "auto" }} className="bg-white pt-2">
        ...
        <Col md="3">
            ...
            <Form.Control type="Number" placeholder="Enter Ticket Id"  style={{ border: "2px solid gray" }} />
            </Form.Group>
        </Col>
